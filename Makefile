...
#    Updated: 2025/07/10 21:20:48 by nimatura         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
DPS := $(SRC_FILE:.c=.d)
SRC_DIR = ./src/
SRC_FILE =	another.c builtins.c env_main.c error_exit.c error_msg.c \
			...
			lst_tools.c debugging_tools.c env_utils.c builtins_unset_utils.c \
